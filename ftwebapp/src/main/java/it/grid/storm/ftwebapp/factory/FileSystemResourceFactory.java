...
public final class FileSystemResourceFactory implements ResourceFactory {
	...
	public FileSystemResourceFactory(String root, String contextPath) {
	...
	public FileSystemResource resolveFile(String host, File file) {
		FileSystemResource r;
		if (!file.exists()) {
			log.warn("file not found: " + file.getAbsolutePath());
			return null;
		} else if (file.isDirectory()) {
			r = new DirectoryResource(host, this, file, contentService);
		} else {
			r = new FileResource(host, this, file, contentService);
		}
		if (r != null) {
